...
export const SOCCER_TEAMS: Team[] = [
  { id: 'arsenal', name: 'Arsenal', logo: 'https://resources.premierleague.com/premierleague/badges/50/t3.png', color: '#EF0107' },
  { id: 'chelsea', name: 'Chelsea', logo: 'https://resources.premierleague.com/premierleague/badges/50/t8.png', color: '#034694' },
  { id: 'liverpool', name: 'Liverpool', logo: 'https://resources.premierleague.com/premierleague/badges/50/t14.png', color: '#C8102E' },
  { id: 'man-city', name: 'Manchester City', logo: 'https://resources.premierleague.com/premierleague/badges/50/t43.png', color: '#6CABDD' },
  { id: 'man-utd', name: 'Manchester United', logo: 'https://resources.premierleague.com/premierleague/badges/50/t1.png', color: '#DA291C' },
  { id: 'tottenham', name: 'Tottenham', logo: 'https://resources.premierleague.com/premierleague/badges/50/t6.png', color: '#132257' },
  { id: 'newcastle', name: 'Newcastle', logo: 'https://resources.premierleague.com/premierleague/badges/50/t4.png', color: '#241F20' },
  { id: 'aston-villa', name: 'Aston Villa', logo: 'https://resources.premierleague.com/premierleague/badges/50/t7.png', color: '#95BFE5' },
  { id: 'brighton', name: 'Brighton', logo: 'https://resources.premierleague.com/premierleague/badges/50/t36.png', color: '#0057B8' },
  { id: 'west-ham', name: 'West Ham', logo: 'https://resources.premierleague.com/premierleague/badges/50/t21.png', color: '#7A263A' },
  { id: 'leicester', name: 'Leicester', logo: 'https://resources.premierleague.com/premierleague/badges/50/t13.png', color: '#003090' },
  { id: 'everton', name: 'Everton', logo: 'https://resources.premierleague.com/premierleague/badges/50/t11.png', color: '#003399' },
  { id: 'wolves', name: 'Wolves', logo: 'https://resources.premierleague.com/premierleague/badges/50/t39.png', color: '#FDB913' },
  { id: 'crystal-palace', name: 'Crystal Palace', logo: 'https://resources.premierleague.com/premierleague/badges/50/t31.png', color: '#1B458F' },
  { id: 'brentford', name: 'Brentford', logo: 'https://resources.premierleague.com/premierleague/badges/50/t94.png', color: '#E30613' },
  { id: 'fulham', name: 'Fulham', logo: 'https://resources.premierleague.com/premierleague/badges/50/t54.png', color: '#000000' },
  { id: 'bournemouth', name: 'Bournemouth', logo: 'https://resources.premierleague.com/premierleague/badges/50/t91.png', color: '#DA291C' },
  { id: 'nottingham', name: 'Nottingham Forest', logo: 'https://resources.premierleague.com/premierleague/badges/50/t17.png', color: '#DD0000' },
  { id: 'burnley', name: 'Burnley', logo: 'https://resources.premierleague.com/premierleague/badges/50/t90.png', color: '#6C1D45' },
  { id: 'sheffield', name: 'Sheffield United', logo: 'https://resources.premierleague.com/premierleague/badges/50/t49.png', color: '#EE2737' },
];
